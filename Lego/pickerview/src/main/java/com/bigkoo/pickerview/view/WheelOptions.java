...
public class WheelOptions<T> {
	...
	public void setPicker(ArrayList<T> options1Items,
		...
		wv_option1.setTextSize(optionsTxtSize);
		wv_option2.setTextSize(optionsTxtSize);
		wv_option3.setTextSize(optionsTxtSize);
